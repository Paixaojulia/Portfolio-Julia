...
## 2 - SQL WHERE Practice Exercise (SQL Interview Question)
...
## 3 - SQL WHERE Practice Exercise (SQL Interview Question)
...
```
## 6 - SQL IN Practice Exercise (SQL Interview Question)
